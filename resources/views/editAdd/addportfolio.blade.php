...
<div class="full_content">
    <div class="container">
        <!--<form class="form-horizontal" method="get" action="{{url('submitaddportfolio')}}" enctype="multipart/form-data" >-->
            {!! Form::open(array('url'=>'submitaddportfolio','method'=>'post','files'=>'true','class'=>'form-horizontal')) !!}
            ...
            <div class="form-group @if($errors->has('pdetails')) has-error @endif" >
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" rows="15" id="pdetails" name="pdetails" ></textarea>
            ...
            <div class="form-group @if($errors->has('link')) has-error @endif" >
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="link" name="link" placeholder="Enter project link">
